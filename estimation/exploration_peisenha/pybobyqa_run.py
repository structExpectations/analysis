...
# We implement a perturbation.
model_params.loc[("disutil_work", "yes_kids_f"), "value"] = 0.6
model_params.loc[("disutil_work", "no_kids_f"), "value"] = 0.3

model_params.loc[("disutil_work", "yes_kids_p"), "value"] = -0.2
model_params.loc[("disutil_work", "no_kids_p"), "value"] = -0.4
...
np.testing.assert_almost_equal(rslt.f, 192958.37944248127)
